...
<td align="center" width="33%">
  <h3>更低推論成本</h3>
  <p>降低閒置率，直接減少每 Token 推論成本。</p>
  <img src="docs/svg-cost.svg" alt="更低推論成本" width="220" />
</td>
<td align="center" width="33%">
  <h3>線性橫向擴展</h3>
  <p>新增節點即可線性提升吞吐量，無需重新部署模型。</p>
  <img src="docs/svg-scale-out.svg" alt="線性橫向擴展" width="220" />
</td>
<td align="center" width="33%">
  <h3>更高並發容量</h3>
  <p>結合 vGPU 切割，同台主機可同時服務更多並行請求。</p>
  <img src="docs/svg-vgpu-concurrency.svg" alt="更高並發容量" width="220" />
</td>
</tr>
</table>
